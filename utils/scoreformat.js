...
module.exports = (games, liveOnly) => {
    ...
    var footer = {
        ...
        "elements": [
            {
                "type": "mrkdwn",
                "text": `Generated by Staturday at ${moment().format('M/D/YYYY h:mm a z')}. Data provided by <https://espn.com|ESPN>. | *<https://www.espn.com/college-football/scoreboard|View ESPN Scoreboard>*`
            }
        ]
    };
